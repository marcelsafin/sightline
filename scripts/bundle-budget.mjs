...
const rawKb = Math.round(raw / 1024), gzKb = Math.round(gz / 1024)
console.log(`bundle: ${rawKb} KB raw · ${gzKb} KB gzip (budget ${BUDGET_RAW_KB} / ${BUDGET_GZIP_KB})`)
if (rawKb > BUDGET_RAW_KB || gzKb > BUDGET_GZIP_KB) {
